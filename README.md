...
See `docs/ADMIN_OPERATIONS.md` and `.env.example` for the required `ADMIN_PASSWORD`, `CRON_SECRET`, screenshot webhook, RPC holder fallback, signing keys, and per-action webhook variables.
