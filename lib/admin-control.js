...
const SWAP_KEYPAIR_CONFIG = {
  base58: ["JUPITER_SWAP_PRIVATE_KEY_BASE58", "DISTRIBUTOR_PRIVATE_KEY_BASE58", "WALLET_PRIVATE_KEY"],
  file: ["JUPITER_SWAP_KEYPAIR_PATH", "DISTRIBUTOR_KEYPAIR_PATH"]
};
const DISTRIBUTOR_KEYPAIR_CONFIG = {
  base58: ["DISTRIBUTOR_PRIVATE_KEY_BASE58", "WALLET_PRIVATE_KEY"],
  file: ["DISTRIBUTOR_KEYPAIR_PATH"]
};
...
async function officialLiveGo(payload = {}) {
  ...
  return {
    ...
    automation: automationPublicState(automation),
    steps,
    message: "Official Live GO armed automation only. Cron will run claim, WBTC buy, holder snapshot, manifest, batch, and distribution when epoch 1 is due."
  };
}
